  ...
  return (
    <section id="control" className="section-pad relative overflow-hidden border-t border-white/8">
      <div className="container-wp">
        <span className="eyebrow">Visualisez votre énergie</span>
        <AnimatedHeading className="mt-6 max-w-6xl">
          <h2 className="display-lg">Chaque watt.<br /><span className="text-white/35">Visible.</span></h2>
        </AnimatedHeading>
        ...
        <div className="mt-20 grid gap-px overflow-hidden rounded-[2rem] border border-white/8 bg-white/8 md:grid-cols-3">
          <div className="bg-[color:var(--background)] p-8 md:p-10">
            <div className="eyebrow">Production solaire</div>
            <div className="mt-8 text-[clamp(3rem,7vw,7rem)] leading-none tracking-[-.06em]"><Counter value={4.8} suffix=" kW" decimals={1} /></div>
            <div className="mt-6 text-[10px] uppercase tracking-[.14em] text-white/25">Données de démonstration</div>
          </div>
          <div className="bg-[color:var(--background)] p-8 md:p-10">
            <div className="eyebrow">Consommation du logement</div>
            <div className="mt-8 text-[clamp(3rem,7vw,7rem)] leading-none tracking-[-.06em]"><Counter value={2.1} suffix=" kW" decimals={1} /></div>
            <div className="mt-6 text-[10px] uppercase tracking-[.14em] text-white/25">Données de démonstration</div>
          </div>
          <div className="bg-[color:var(--background)] p-8 md:p-10">
            <div className="eyebrow">Niveau de batterie</div>
        ...
        <div className="relative mt-16 h-72 overflow-hidden rounded-[2rem] border border-white/8 bg-white/[.018] p-6 md:h-96 md:p-10">
          ...
          <div className="relative flex items-center justify-between"><span className="eyebrow">Production / consommation</span><span className="text-[10px] uppercase tracking-[.14em] text-white/25">Données de démonstration</span></div>
          <svg className="relative mt-8 h-[70%] w-full" viewBox="0 0 1200 300" fill="none" aria-label="Visualisation énergétique de démonstration">
